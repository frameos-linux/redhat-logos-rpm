...
Version: 4.9.99
Release: 12.el5.frameos
Group: System Environment/Base
Source0: redhat-logos-%{version}-centos.tar.bz2
Source1: redhat-logos-anaconda-frameos-5.1.tar.bz2
Source2: redhat-logos-frameos-bootloader.tar.bz2
...
%changelog
* Wed Jun 09 2010 Sergio Rubio <sergio@rubio.name> 4.9.99-12.el5.frameos
- Added FrameOS artwork
